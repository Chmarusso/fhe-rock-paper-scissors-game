  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6 text-gray-900">
      ...
      <div className="text-center mb-8 text-black">
        <h1 className="text-3xl font-bold mb-2">🪨📄✂️ FHE Rock Paper Scissors</h1>
        <p className="text-gray-600">Play Rock Paper Scissors with fully encrypted moves using FHE</p>
      </div>
        ...
        <div className="space-y-3">
          ...
          {game.gameData && (
            <>
              ...
              {game.gameData.status === GameStatus.Completed && game.decryptedResults && (
                <div className="mt-4 p-4 bg-white border-2 border-green-300 rounded-lg">
                  <p className="text-lg font-bold text-green-800 text-center">{getWinnerText()}</p>
                </div>
              )}
            </>
          )}
        ...
        {!game.hasContract && (
          <div className="mb-4 p-4 bg-yellow-100 border border-yellow-400 rounded-lg">
            ...
            <ol className="list-decimal list-inside text-yellow-700 text-sm mt-2 space-y-1">
              <li>Deploy the contract: <code className="bg-yellow-200 px-1 rounded">cd packages/hardhat && npx hardhat deploy</code></li>
              <li>Generate contract types: <code className="bg-yellow-200 px-1 rounded">npm run generate</code></li>
            </ol>
          </div>
        )}
